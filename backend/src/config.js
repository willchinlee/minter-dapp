...
const extraMetadata = {
  external_url: "https://animaemilk", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'Anime Milk';
const CONTRACT_SYMBOL = 'AnMi';
